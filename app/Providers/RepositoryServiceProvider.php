...
class RepositoryServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
      ...
      $this->app->bind(
        'CodeDelivery\Repositories\RestaurantRepository',
        'CodeDelivery\Repositories\RestaurantRepositoryEloquent'
      );

      $this->app->bind(
        'CodeDelivery\Repositories\AddressesRepository',
        'CodeDelivery\Repositories\AddressesRepositoryEloquent'
      );
    }
}
